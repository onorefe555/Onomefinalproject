...
const localStoragewhole_income_store =JSON.parse(localStorage.getItem("whole_income_store "))
if (localStoragewhole_income_store) {
    whole_income_store = localStoragewhole_income_store
    amountCalc()
    renderAmount()
}
...
//    total_amount = (+amount_paid.value)+amount_el
   total_amount=  whole_income_store.push(+amount_paid.value + amount_el)
   ...
   amount_el = amount_el + parseInt(amount_paid.value)
    ...
    localStorage.setItem("whole_income_store", JSON.stringify(whole_income_store))
}
